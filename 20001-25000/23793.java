...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		int a = dijkstra(x, y, 0);
		int b = dijkstra(y, z, 0);
		int c = dijkstra(x, z, y);
		
		System.out.print(((a == INF || b == INF) ? -1 : a + b) + " " + (c == INF ? -1 : c));
    }
	
	public static int dijkstra(int start, int end, int not) {
